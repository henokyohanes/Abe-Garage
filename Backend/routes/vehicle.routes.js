...
router.post('/api/vehicle/:customer_id', authMiddleware.verifyToken, vehicleController.createVehicle);
...
router.put('/api/update-vehicle/:id', authMiddleware.verifyToken, vehicleController.updateVehicle);
